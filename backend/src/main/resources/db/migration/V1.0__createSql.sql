...
create table placeholder_entity (id bigint not null, a integer not null, b integer not null, c integer not null, counter integer not null check (counter<=20 AND counter>=0), version integer, primary key (id));
